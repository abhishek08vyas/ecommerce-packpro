		...
		<footer className="border-t bg-card">
			<div className="container mx-auto px-4 pt-10 md:pt-14 pb-6 md:pb-8">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-6">
					...
					<div className="flex flex-col gap-4 sm:col-span-2 lg:col-span-1">
						<div className="flex items-center gap-2.5">
							...
							<span className="text-xl font-bold text-card-foreground">PackPro Solutions</span>
						</div>
						<p className="text-sm text-muted-foreground leading-relaxed max-w-xs">Premium packaging solutions for businesses of all sizes. Quality you can trust, delivered with care.</p>
					</div>
				...
				<div className="flex flex-col-reverse sm:flex-row justify-between items-center gap-3 sm:gap-0">
					<p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} PackPro Solutions. All rights reserved.</p>
